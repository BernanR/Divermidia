<div class="form-col d-flex justify-content-center mb-5 col-sm-12 form-footer">            
    <form class="form w-75" data-remote="true" focus-response="#message" id="form" method="POST" action="<?php echo base_url('WB_Form_controller/index'); ?>">
