			...
			var s = $(r),
				...
				f = {
					...
					_onChange: function(e, d) {							
						...
						/* PEGAR O VALOR DO SCOPE ANGULARJS*/
						if(f._assets.hasAttr('data-angular-uploadData')) {
							n.uploadFile.data = JSON.parse(s.attr('data-angular-uploadData'));
						}

						console.log(n.uploadFile.data);
